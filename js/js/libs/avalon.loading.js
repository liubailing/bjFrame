...
define(function(require) {
    ...
    if(sysConfig.jsTracking) avalon.log('seajs-Tracking："loading---加载效果组件"'); 
    require("A-common-css");
    require("A-loading-css"); 

    var template = require("text!../libs/model/avalon.loading.html");
    var ballTemplate = require("text!../libs/model/avalon.loading.bar.html");
    var widgetCount = 0, 
