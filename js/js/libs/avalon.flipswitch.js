...
define(function(require) {
    ...
    if(sysConfig.jsTracking) avalon.log('seajs-Tracking："flipswitch---滑动按钮组件"');
    require("A-flipswitch-css");
    require("A-common-css");

    var template = require("text!../libs/model/avalon.flipswitch.html");
