...
define(function(require) {
    ...
    if (sysConfig.jsTracking) avalon.log('seajs-Tracking："tooltip--气泡组件"');
    require("A-tooltip-css");   
    require("A-common-css");    

    var undefine
    var template = require("text!../libs/model/avalon.tooltip.html");
    var widget = avalon.ui.tooltip = function(element, data, vmodels) {
        var options = data.tooltipOptions,
            selfContent = "",
            hideTimer, animateTimer, tooltipElem, customAt = options.positionAt,
            ...
            arrW = 10,
            p = options.position,
            constantInited, ofElement // 用来给tooltip元素定位的，可以元素，也可以是事件
            , _event_ele // 事件起始元素
